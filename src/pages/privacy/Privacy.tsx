...
условное форматирование элементов в зависимости от их характеристик, а также присутствия в корзине
Прилагать скриншоты проекта
*/
/*
Д.З. Внедрить в свой курсовой проект
страницу отображения заказа клиента (корзина)
*/